...
export const payoutPageRows = [
  ...
  { betType: BetType.FRONT_THREE, label: "2 โต๊ด" },
...
export const navigationItems = [
  ...
  { href: "/dashboard/tickets", label: "ดูโพย", roles: [Role.ADMIN, Role.CUSTOMER] },
  { href: "/dashboard/limits", label: "เลขอั้น/เต็ม", roles: [Role.ADMIN] },
  { href: "/dashboard/users", label: "สมาชิก", roles: [Role.ADMIN] },
  { href: "/dashboard/payouts", label: "ส่วนลด", roles: [Role.ADMIN] },
  { href: "/dashboard/tickets/new", label: "คีย์โพย", roles: [Role.CUSTOMER] },
];
